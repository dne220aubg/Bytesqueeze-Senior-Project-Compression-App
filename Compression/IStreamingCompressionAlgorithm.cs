...
namespace SeniorProjectCompressionApp.Compression
{
    ...
    {
        Task CompressAsync(Stream input, Stream output, CancellationToken cancellationToken);
        Task DecompressAsync(Stream input, Stream output, CancellationToken cancellationToken);
    }
}
